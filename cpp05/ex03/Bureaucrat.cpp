...
/*   Updated: 2025/05/05 18:35:19 by chajeon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(AForm const & form) const
{
	try
	{
		std::cout << std::endl << std::endl << "----------------[Execute Result]----------------" << std::endl;
		form.execute(*this);
		std::cout << std::endl << std::endl << _name << " executed " << form.getName() << std::endl;
	}
